...
public class GrappleSystem : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (!ropeAttached)
        {
            inputController.isSwinging = false;

            SetCrosshairPosition(inputController.aimAngle);
        }
        if (ropeAttached)
        {
            inputController.isSwinging = true;
            inputController.ropeHook = ropePositions.Last();
    ...
    public void HandleRopeLength(float vertical)
    {
        ...
        {
            ropeJoint.distance -= Time.deltaTime * inputController.climbSpeed;
        }
